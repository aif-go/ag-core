...
func TestProbe_SetDefaultReplace_Orphan(t *testing.T) {
	stop := startFx(t, nil)
	mustCache[string](t, dflt(), "orphan", func(ctx context.Context, key string) (string, error) { return "x", nil })
	...
	_, _ = ag_cache.GetCache[string](dflt(), "whatever")
...
func TestProbe_SameNameDifferentType(t *testing.T) {
	...
	mustCache[string](t, dflt(), "dup", func(ctx context.Context, key string) (string, error) { return "s", nil }).Get(ctx, "k")
	defer func() {
		if r := recover(); r != nil {
			t.Logf("OK: 同名不同类型 panic（契约生效）: %v", r)
		}
	}()
	mustCache[int](t, dflt(), "dup", func(ctx context.Context, key string) (int, error) { return 1, nil }).Get(ctx, "k")
}
...
func TestProbe_WeirdKeyCharacters(t *testing.T) {
	...
	c := mustCache[string](t, dflt(), "weird", func(ctx context.Context, key string) (string, error) {
...
func TestProbe_GlobalRegistry_FixedByFirstAssembly(t *testing.T) {
	...
	stop1 := startFx(t, nil)
	c1, _ := ag_cache.GetCache[string](dflt(), "load")
...
func TestProbe_SetDroppedBufferFull(t *testing.T) {
	...
	c := mustCache[string](t, dflt(), "probe-buffer", func(ctx context.Context, key string) (string, error) {
		return "v", nil
	})
	var dropped int
	var mu sync.Mutex
