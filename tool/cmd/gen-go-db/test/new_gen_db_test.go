...
func TestFindByStruct(t *testing.T) {
	...
	testCases := []struct {
		...
		{name: "场景7:索引+特殊列-JpaVersion", entity: &model.TmTeacher{Name: "test1", JpaVersion: ver(1)}, wantErr: false},
		...
		{name: "场景10:仅特殊列无索引-预期错误", entity: &model.TmTeacher{JpaVersion: ver(1)}, wantErr: true},
