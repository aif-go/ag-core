...
const (
	...
	hertzServerPackage = protogen.GoImportPath("ag-core/ag/ag_hertz/server")
	hertzClientPackage = protogen.GoImportPath("ag-core/ag/ag_hertz/client")
...
func generateFile(gen *protogen.Plugin, file *protogen.File, omitempty bool, omitemptyPrefix string, t string) *protogen.GeneratedFile {
	if len(file.Services) == 0 || (omitempty && !hasHTTPRule(file.Services)) {
		return nil
	}
	filename := file.GeneratedFilenamePrefix + "_" + t + ".pb.go"
	...
	g.P()
	generateFileContent(gen, file, g, omitempty, omitemptyPrefix, t)
	return g
}

// generateFileContent generates the kratos errors definitions, excluding the package statement.
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, omitempty bool, omitemptyPrefix string, t string) {
	...
	for _, service := range file.Services {
		genService(gen, file, g, service, omitempty, omitemptyPrefix, t)
	}
}

func genService(_ *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service, omitempty bool, omitemptyPrefix string, t string) {
